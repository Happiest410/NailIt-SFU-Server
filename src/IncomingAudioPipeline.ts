...
export class IncomingAudioPipeline{
    ...
    private opusDecoder = new opus.OpusEncoder(48000, 2);
...
start(): Promise<number> {
    ...
    async handleIncomingPacket(msg:any){
        ...
        try {
            ...
            // if (this.mediaBridge.candidateAudioPayloadType !== undefined && rtp.payloadType !==this.mediaBridge.candidateAudioPayloadType ) {
            //   return;
            // }
...
console.log("sendAudio:", Date.now() - start);
                  } else {
